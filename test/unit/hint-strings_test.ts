...
test("reverseString handles astral characters", () => {
...
test("hintStrings only use alphabet characters", () => {
  const alphabet = "abc";
...
test("hintStrings matches the reference algorithm exactly", () => {
...
test("hintStrings scatters the short hints", () => {
...
test("hintStrings grows length only as needed", () => {
  const alphabet = "abcd";
...
test("normaliseHintCharacters removes duplicates and whitespace", () => {
...
test("normaliseHintCharacters falls back on unusable alphabets", () => {
...
test("numberToHintString is decimal for the default digit set", () => {
...
test("numberToHintString honours a custom digit set", () => {
...
test("numberToHintString rejects degenerate input", () => {
...
test("matchByPrefix returns every index for an empty query", () => {
  assertEquals(matchByPrefix(["aa", "ab", "b"], ""), [0, 1, 2]);
});

test("matchByPrefix narrows as characters are typed", () => {
  const hints = ["aa", "ab", "b"];
